...
<head>
	...
	<title>Detail History Cuti</title>
	...
	<link href="<?= config_item('url_template'); ?>eservices/historydetail.css" rel="stylesheet">
	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<?php
				$this->load->view("history/detail/v_content_historycuti.php");
				?>
			</div>
			<!-- /page content -->
