...
<head>
	...
	<title>Detail Approval Datang Telat / Pulang Cepat</title>
    ...
    <link href="<?= config_item('url_template'); ?>absensi/approval.css" rel="stylesheet">
	...
	<div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<?php $this->load->view("listapproval/detail/v_content_listapproval.php"); ?>
			</div>
			<!-- /page content -->
