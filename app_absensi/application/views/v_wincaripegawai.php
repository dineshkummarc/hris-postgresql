			...
			function(response){
				if(response.success){
					...
					$.each(response.data, function(index, record){
						html += '<tr data-pegawaiid="'+record.pegawaiid+'" data-nik="'+record.nik+'" data-nama="'+record.nama+'" data-jabatan="'+record.jabatan+'" data-satkerid="'+record.satkerid+'" data-satker="'+record.divisi+'" data-lokasi="'+record.lokasi+'" data-hp="'+record.hp+'">';
							html += '<td>'+(index+1)+'</td>';
