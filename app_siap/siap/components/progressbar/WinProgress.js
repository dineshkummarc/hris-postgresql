Ext.define("SIAP.components.progressbar.WinProgress",{
	extend: "Ext.window.Window",
	alternateClassName: "SIAP.WinProgress",
		...
		Ext.apply(me, {			
			...
			items: [
				{xtype: 'panel', border: false,
					items: [
						{ style: 'padding:5px 5px 5px 10px;border:none !important;', border: false, html: '<div id="idjmldata"> Jumlah Data : </div>'},
						{ style: 'padding:10px', border: false, html: '<div id="panelprogress" style="background-color:#ddd;height:20px" width="20"></div>'}					
					]
				}
			]			
		});		
