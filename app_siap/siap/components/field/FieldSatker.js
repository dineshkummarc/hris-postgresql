Ext.define('SIAP.components.field.FieldSatker',{
	extend: 'SIAP.abstract.FieldButton',
	alias: 'widget.fieldsatker',	
	requires:[
		'SIAP.components.window.UnitKerja'
	],		
	config:{},	
	URL_SATKER: '',	
	...
	getFieldLabel:function(){
		if(this.fieldLabel=='unknown')
			return 'Master Unit Kerja';
		else return this.fieldLabel;
	},	
	createWindow:function(){
		var me=this;
		return Ext.create('SIAP.components.window.UnitKerja', {
			width: 400, height: 500,
			listeners: {
				pilih: function(p, records){
					me.field.setValue(records.get('text'));
					me.fieldid.setValue(records.get('id'));
					me.fireEvent('pilih', p, records);
				}
			}
		});
	}
