			...
			items: [
				{ xtype: 'form', waitMsgTarget:true, bodyPadding: 15, layout: 'anchor', defaultType: 'textfield', region: 'center', autoScroll: true,
					...
					items: [
						...
						{fieldLabel: 'KPI Company', name: 'kpicompany'},
						{fieldLabel: 'KPI Individu', name: 'kpiindividu'},
						{fieldLabel: 'PA Individu', name: 'paindividu'},
						{fieldLabel: 'Total', name: 'total2'},
						{fieldLabel: 'Performance Rating', name: 'pr'},
					]
				},
			]
		});	
