                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                { xtype: 'hidden', name: 'lainlain' },
                                { xtype: 'hidden', name: 'biayatiket' },
                                { xtype: 'hidden', name: 'biayatransport' },
                                { xtype: 'hidden', name: 'biayauangsaku' },
                                { xtype: 'hidden', name: 'biayahotel' },
                                { xtype: 'hidden', name: 'aktif' },
                                { xtype: 'hidden', name: 'acco' },
                                {
                                    layout: 'column',
                                    baseCls: 'x-plain',
                                    border: false,
                                                    ...
                                                    listeners: {
                                                        edit: function (editor, e) {
                                                            if (statusid == '5' && Settings.userid == '1235' && jenisformid == '1') {
                                                                ...
                                                                var budgetacc = form.findField('accomodation').getValue();
                                                                var totalhistory = form.findField('totalhistory').getValue();
                                                                var biayatiket = form.findField('biayatiket').getValue();
                                                                var biayalainlain = form.findField('lainlain').getValue();
                                                                var uangsaku = e.record.data['uangsaku'];
                                                                var tiket = e.record.data['biayatiket'];
                                                                var transport = e.record.data['transport'];
                                                                var hotel = e.record.data['hotelprice'];
                                                                var lainlain = e.record.data['lainlain'];
                                                                var aktif = form.findField('aktif').getValue();

                                                                if (aktif == 'Y') {
                                                                    Ext.Msg.show({
                                                                        title: 'Attention',
                                                                        msg: 'Maaf Tidak Bisa Edit Rincian Biaya',
                                                                        buttons: Ext.Msg.OK,
                                                                        icon: Ext.Msg.QUESTION,
                                                                    });
                                                                } else if (aktif == '') {
                                                                    Ext.Msg.show({
                                                                        title: 'Attention',
                                                                        msg: 'Maaf Klik Tombol Reset Rincian Biaya Untuk Edit',
                                                                        buttons: Ext.Msg.OK,
                                                                        icon: Ext.Msg.QUESTION,
                                                                    });
                                                                } else {
                                                                    Ext.Ajax.request({
                                                                        url: Settings.SITE_URL + '/perjalanandinas/addrincianbiaya',
                                                                        method: 'POST',
                                                                        params: {
                                                                            pengajuanid: pengajuanid,
                                                                            uangsaku: uangsaku,
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        var tid = form.findField('tid').getValue();
                                        var aid = form.findField('aid').getValue();
                                        var tiket = form.findField('biayatiket').getValue();
                                        var totalacco = form.findField('acco').getValue();
                                        var aktif = form.findField('aktif').getValue();

                                        if (aktif == 'Reset') {
                                            Ext.Msg.show({
                                                title: 'Attention',
                                                msg: 'Anda Harus Input Rincian Biaya',
                                                buttons: Ext.Msg.OK,
                                                icon: Ext.Msg.QUESTION,
                                            });
                                        } else {
                                            Ext.Msg.show({
                                                title: 'Reset Rincian Biaya',
                                                msg: ' Apa Anda Yakin Reset Rincian Biaya',
                                                buttons: Ext.Msg.YESNO,
                                                icon: Ext.Msg.QUESTION,
                                                fn: function (btn) {
                                                    if (btn == 'yes') {
                                                        Ext.Ajax.request({
                                                            url: Settings.SITE_URL + '/perjalanandinas/resetrincianbiaya',
                                                            method: 'POST',
                                                            params: {
                                                                pengajuanid: pengajuanid,
                                                                periode: periode,
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        var tid = form.findField('tid').getValue();
                                        var aid = form.findField('aid').getValue();
                                        var lainlain = form.findField('lainlain').getValue();
                                        var tiket = form.findField('biayatiket').getValue();
                                        var uangsaku = form.findField('biayauangsaku').getValue();
                                        var transport = form.findField('biayatransport').getValue();
                                        var hotelprice = form.findField('biayahotel').getValue();
                                        var budgettiket = form.findField('ticket').getValue();
                                        var budgetacc = form.findField('accomodation').getValue();
                                        var totalhistory = form.findField('totalhistory').getValue();
                                        var total = parseInt(uangsaku) + parseInt(transport) + parseInt(hotelprice) + parseInt(lainlain) + parseInt(tiket);
                                        var totalacco = parseInt(uangsaku) + parseInt(transport) + parseInt(hotelprice) + parseInt(lainlain);
                                        var aktif = form.findField('aktif').getValue();

                                        if (aktif == 'Y' || aktif == 'Reset') {
                                            Ext.Msg.show({
                                                title: 'Attention',
                                                msg: 'Maaf Anda Tidak Bisa Menghitung Total',
                                                buttons: Ext.Msg.OK,
                                                icon: Ext.Msg.QUESTION,
                                            });
                                        } else {
                                            Ext.Msg.show({
                                                title: 'Hitung Total',
                                                msg: 'Apakah Anda Yakin Dengan Rincian Biaya?',
                                                buttons: Ext.Msg.YESNO,
                                                icon: Ext.Msg.QUESTION,
                                                fn: function (btn) {
                                                    if (btn == 'yes') {
                                                        Ext.Ajax.request({
                                                            url: Settings.SITE_URL + '/perjalanandinas/totalrincianbiaya',
                                                            method: 'POST',
                                                            params: {
                                                                pengajuanid: pengajuanid,
                                                                periode: periode,
            ...
            tbar: [
...

                {
                    ...
                    handler: function () {
                        ...
                        } else if (aktif == '' || aktif == 'Edit' || (aktif == 'Reset' && jenisformid == '1')) {
                            Ext.Msg.show({
                                title: 'Hitung Total',
                                msg: 'Anda harus melakukan pengecekan total rincian biaya',
                                buttons: Ext.Msg.OK,
                                icon: Ext.Msg.QUESTION,
                            });
                        } else {
