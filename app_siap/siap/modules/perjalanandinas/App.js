Ext.define('SIAP.modules.perjalanandinas.App', {
    extend: 'Ext.panel.Panel',
    alternateClassName: 'SIAP.perjalanandinas',
    alias: 'widget.perjalanandinas',
    requires: ['SIAP.components.tree.UnitKerja', 'SIAP.modules.perjalanandinas.GridCuti', 'SIAP.components.field.ComboStatusPjdinas', 'SIAP.components.field.ComboJenisFormPjdinas'],
                ...
                },
                {
                    ...
                    listeners: {
                        beforeload: function (store) {
                            ...
                            var jenisformid = me.down('#id_jenisform').getValue();
                            if (m.length > 0) {
                                satkerid = m[0].get('id');
                            }
                            ...
                            store.proxy.extraParams.jenisformid = jenisformid;
                        },
                    },
                    tbar: [
                        {
                        ...
                        '-',
                        { itemId: 'id_statuscuti', xtype: 'combostatuspjdinas', emptyText: 'Status Perjalanan' },
                        { itemId: 'id_jenisform', xtype: 'combojenisformpjdinas', emptyText: 'Jenis Form' },
                        {
