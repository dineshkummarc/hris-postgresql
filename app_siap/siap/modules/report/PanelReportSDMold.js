Ext.define("SIAP.modules.report.PanelReportSDM", {
	...
	initComponent: function(){
		...
		var storereportsdm = Ext.create('Ext.data.Store', {
			...
			fields: [
				'levelid', 'level', 'gol', {name: 'status1', type: 'int'}, {name: 'status2', type: 'int'}, {name: 'totstatus', type: 'int'}, 
				{name: 'mskerja1', type: 'int'}, {name: 'mskerja2', type: 'int'}, {name: 'mskerja3', type: 'int'}, {name: 'mskerja4', type: 'int'}, 
				{name: 'totmasakerja',type: 'int'}, {name: 'pend0', type: 'int'}, {name: 'pend1', type: 'int'}, {name: 'pend2', type: 'int'}, 
				{name: 'pend3', type: 'int'}, {name: 'pend4', type: 'int'}, {name: 'totpend', type: 'int'}, 
				{name: 'lok1', type: 'int'}, {name: 'lok2', type: 'int'}, {name: 'lok3', type: 'int'}, {name: 'totlokasi', type: 'int'}, 
			],
			listeners: {
		...
		var storereportsdmbyid = Ext.create('Ext.data.Store', {
			...
			fields: [
				...
				'levelid', 'level', 'lokasiid', 'lokasi','statuspegawai', 'tglmulai', 'tglakhirkontrak', 'masakerjaseluruhth', 'masakerjaseluruhbl','pendidikan'
			],
			listeners: {
				beforeload: function(store){
					me.fireEvent("beforeload", store);
			...
			items: [
				...
				autoScroll: true, frame: false, border: true, loadMask: true, stripeRows: true,
					...
					columns: [
						...
						{header: 'Status', dataIndex: 'level',
							columns:[
								{header: 'Permanent', dataIndex: 'status1', width: 70, align:'center',
								...
								{header: 'Contract', dataIndex: 'status2', width: 70,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											tot2 = 0,
								...
								{header: 'Total', dataIndex: 'totstatus', width: 70,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totstatus = 0,
						...
						{header: 'Lokasi', align: 'left',
							columns:[
								{header: 'HO', dataIndex: 'lok1', width: 70,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totpend0 = 0,
								...
								{header: 'Store', dataIndex: 'lok3', width: 70,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totpend1 = 0,
								...
								{header: 'DC', dataIndex: 'lok2', width: 80,  align:'center',
									summaryType: function(records, values){ 
										var i = 0,
											length = records.length,
											totpend2 = 0,
								...
								{header: 'Total', dataIndex: 'totlokasi', width: 80,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totpend = 0,
						...
						{header: 'Masa Kerja (th)', align: 'left',
							columns:[
								{header: '< 5', dataIndex: 'mskerja1', width: 60,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totmskerja1 = 0,
								...
								{header: '5 - 10', dataIndex: 'mskerja2', width: 60,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totmskerja2 = 0,
								...
								{header: '10 - 15', dataIndex: 'mskerja3', width: 60,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totmskerja3 = 0,
								...
								{header: '> 15', dataIndex: 'mskerja4', width: 60,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totmskerja4 = 0,
								...
								{header: 'Total', dataIndex: 'totmasakerja', width: 60,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totmasakerja = 0,
						...
						{header: 'Pendidikan', align: 'left',
							columns:[
								{header: 'SLTP', dataIndex: 'pend0', width: 70,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totpend0 = 0,
								...
								{header: 'SLTA', dataIndex: 'pend1', width: 70,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totpend1 = 0,
								...
								{header: 'Diploma', dataIndex: 'pend2', width: 80,  align:'center',
									summaryType: function(records, values){ 
										var i = 0,
											length = records.length,
											totpend2 = 0,
								...
								{header: 'Sarjana', dataIndex: 'pend3', width: 80,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totpend3 = 0,
								...
								{header: 'Magister', dataIndex: 'pend4', width: 80,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totpend4 = 0,
								...
								{header: 'Total', dataIndex: 'totpend', width: 80,  align:'center',
									summaryType: function(records, values){
										var i = 0,
											length = records.length,
											totpend = 0,
				...
				{xtype: 'grid', region: 'south', title: 'Data Karyawan', height: 250, collapsed: true, collapsible: true,
					...
					columns: [
						...
						{text: 'Masa Kerja', dataIndex: 'lama', 
