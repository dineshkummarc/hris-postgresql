Ext.define("SIAP.modules.report.PanelReportPegawaiAktif", {
	extend: "Ext.panel.Panel",
	alternateClassName: "SIAP.panelreportpegawaiaktif",
	alias: 'widget.panelreportpegawaiaktif',
	initComponent: function(){
		var me = this;
		
		var store_chart_pegaktif = Ext.create('Ext.data.Store', {
			autoLoad: true,
			proxy: {
				type: 'ajax',
		...
		var storereportpegaktif = Ext.create('Ext.data.Store', {
			storeId: 'storereportpegaktif',
			autoLoad: true,
