    ...
    initComponent: function () {
        ...
        var storereportkadergroup = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                timeout: 10000000,
                url: Settings.SITE_URL + '/report/getReportListKaderGroup',
                actionMethods: {
                    create: 'POST',
                    read: 'POST',
                },
        ...
        Ext.apply(me, {
            ...
            tbar: [
                ...
                //         }
                //         Ext.getStore('storereportkadergroup').proxy.extraParams.satkerid = treeid;
                //         Ext.getStore('storereportkadergroup').proxy.extraParams.level = Ext.ComponentQuery.query('#id_ketlevel')[0].getValue();
                //         Ext.getStore('storereportkadergroup').proxy.extraParams.lokasi = Ext.ComponentQuery.query('#id_ketlokasi')[0].getValue();
